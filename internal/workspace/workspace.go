...
type Workspace interface {
	...
	SetAutoResumeThreshold(scope config.Scope, threshold int) error
	SetAutoResumeModel(scope config.Scope, model string) error
	SetDisableAutoResume(scope config.Scope, disabled bool) error
