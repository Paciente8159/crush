...
func (m *mockSessionAgent) Summarize(context.Context, string, string, config.SelectedModelType, fantasy.ProviderOptions, func(context.Context, *fantasy.ProviderError) error) error {
	return nil
}
